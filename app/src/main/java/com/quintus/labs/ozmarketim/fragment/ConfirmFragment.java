...
import com.quintus.labs.ozmarketim.activity.BaseActivity;
import com.quintus.labs.ozmarketim.activity.CartActivity;
import com.quintus.labs.ozmarketim.activity.MainActivity;
import com.quintus.labs.ozmarketim.adapter.CheckoutCartAdapter;
import com.quintus.labs.ozmarketim.model.Cart;
import com.quintus.labs.ozmarketim.model.Order;
...
public class ConfirmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orderNo = "Sipariş #" + (100000 + rnd.nextInt(900000));
    ...
    private void closeProgress() {
        ...
        Order order = new Order(id, orderNo, currentDateandTime, "₺" + _totalAmount, "Bekliyor");
        orderList.add(order);
